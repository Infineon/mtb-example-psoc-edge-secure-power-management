...
The following example clones the "[Secure Power Management](https://github.com/Infineon/mtb-example-psoc-edge-secure-power-management)" application with the desired name "SPM" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-secure-power-management --user-app-name SPM --target-dir "C:/mtb_projects"
   ```
